...
from src.SiFiCCNN.InputGenerator import IGRNNClusterS1AX_restricted
...
def generate_sxax(n_cs, n_ca):
    ...
    IGRNNClusterS1AX_restricted.export_sxax(rootcluster_cont, dir_npz, 7)
    IGRNNClusterS1AX_restricted.export_sxax(rootcluster_bp0mm, dir_npz, 7)
    IGRNNClusterS1AX_restricted.export_sxax(rootcluster_bp5mm, dir_npz, 7)
...
def check_sxax():
    ...
    npz_data_bp5mm = np.load(dir_npz + "OptimisedGeometry_BP5mm_4e9protons_withTimestamps_RNN_S1A7.npz")
