...
def display(event,
    ...
    list_cone = EDBuilder.get_compton_cone(vec_ax1, vec_ax2, vec_src,
                                           event.scatter_angle_dotvec, sr=128)
    ...
    reco_theta = compton_scattering_angle(e1, e2)
    vec_src = event.MCPosition_source
    ...
    # Compton cone definition, defined by reco cluster positions
    vec_ax1 = TVector3(ary_nn_reco[3], ary_nn_reco[4], ary_nn_reco[5])
    vec_ax2 = TVector3(ary_nn_reco[6], ary_nn_reco[7], ary_nn_reco[8])
    e1 = ary_nn_reco[1]
    e2 = ary_nn_reco[2]
    reco_theta = compton_scattering_angle(e1, e2)
    vec_src = event.MCPosition_source
