...
NPZ_FILE_TRAIN = "OptimisedGeometry_Continuous_2e10protons_DNN_S4A6.npz"
# Evaluation files
# Generated via an input generator, contain one Bragg-peak position
NPZ_FILE_EVAL_0MM = "OptimisedGeometry_BP0mm_2e10protons_withTimestamps_DNN_S4A6.npz"
NPZ_FILE_EVAL_5MM = "OptimisedGeometry_BP5mm_4e9protons_withTimestamps_DNN_S4A6.npz"
...
tfmodel_clas = DNN_SXAX_classifier.return_model(100)
tfmodel_regE = DNN_SXAX_regression_energy.return_model(100)
tfmodel_regP = DNN_SXAX_regression_position.return_model(100)
tfmodel_regT = DNN_SXAX_regression_theta.return_model(100)
