...
# Training file
NPZ_FILE_TRAIN = "OptimizedGeometry_BP05_dist.npz"
# NPZ_FILE_TRAIN = "OptimisedGeometry_BP0mm_2e10protons_DNN_S1AX.npz"
# Evaluation file (can be list)
NPZ_FILE_EVAL = ["OptimisedGeometry_BP0mm_2e10protons_DNN_dist.npz",
                 "OptimisedGeometry_BP5mm_4e9protons_DNN_fist.npz"]
