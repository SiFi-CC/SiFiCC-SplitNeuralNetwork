...
from SiFiCCNN.utils.layers import ECCConvResNetBlock, ReZero
...
def setupModel(F=10,
    ...
    x = ECCConv(nFilter, activation=activation, use_bias=True)([X_in, A_in, E_in])

    x = ECCConvResNetBlock(*[x, A_in, E_in], nFilter, activation)
    x = ECCConvResNetBlock(*[x, A_in, E_in], nFilter, activation)
