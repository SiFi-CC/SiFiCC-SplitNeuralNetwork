...
from ClassificationGCNConvResNetCluster import NNmodel
...
def training(dataset_name,
    ...
    tf_model.save(RUN_NAME + "_regressionEnergy")
...
def evaluate(dataset_name,
    ...
    tf_model = tf.keras.models.load_model(RUN_NAME + "_regressionEnergy")
