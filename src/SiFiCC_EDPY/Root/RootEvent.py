...
class Event:
    ...
    def __init__(self,
        ...
        # MC-TRUTH CLASSIFICATION TAGS AND REGRESSION TARGETS
        # CURRENTLY ALL SET NEGATIVE AS TARGETS STILL NEED FIX IN SIMULATION
        # TODO: FIX THIS
        self.is_real_coincidence = True if self.MCSimulatedEventType in [2, 5] else False
        self.is_compton = True if self.MCEnergy_e != 0.0 else False
        self.is_idealcompton = False
