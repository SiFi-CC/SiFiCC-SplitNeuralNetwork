...
def gen_input(list_rootparser):
    ...
    for k in range(len(list_rootparser)):
        ...
        for i, event in enumerate(list_rootparser[k].iterate_events(n=None)):
            ...
            ary_targets[idx_pos] = event.is_complete_distributed_compton * 1
    ...
    with open(dir_npz + "OptimizedGeometry_BP05_dist" + ".npz", 'wb') as f_output:
